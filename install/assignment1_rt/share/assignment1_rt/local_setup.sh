...
: ${AMENT_CURRENT_PREFIX:="/root/assignment1_rt/install/assignment1_rt"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/assignment1_rt/environment/pythonpath.sh"
